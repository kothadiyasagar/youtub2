const searchvideos = async ()=>{
    ...
    try {
        ...
        let res =await fetch(`https://youtube.googleapis.com/youtube/v3/videos?part=snippet&chart=mostPopular&regionCode=IN&key=AIzaSyBJCmNQ0j9nNOXKEG43GxX0Xp4CtVdPaiY&maxResults=50`)
...
//              console.log(el)
        ...
        //  'https://youtube.googleapis.com/youtube/v3/videos?part=snippet&regionCode=IN&key=[YOUR_API_KEY]'
